# Stability Quad — MD Interface Stability Visualization
...
The Stability Quad framework was developed during the C12orf29/IBAM project to provide rapid visual assessment of molecular dynamics stability, interface persistence, and contact redistribution in predicted IBAM–MyT complexes.
...
```bash
python stability_plot_script.py --species "Ciona intestinalis"
```
...
![Stability Quad — Ciona intestinalis](example_output/Ciona_intestinalis_md_StabilityQuad.png)
